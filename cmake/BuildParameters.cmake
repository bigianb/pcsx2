...
if(${PCSX2_TARGET_ARCHITECTURES} MATCHES "x86_64" OR ${PCSX2_TARGET_ARCHITECTURES} MATCHES "i386" OR
   ${PCSX2_TARGET_ARCHITECTURES} MATCHES "aarch64" OR ${PCSX2_TARGET_ARCHITECTURES} MATCHES "armv7")
...
elseif(${PCSX2_TARGET_ARCHITECTURES} MATCHES "x86_64")
	...
	set(_M_X86 1)
	set(_M_X86_64 1)
elseif(${PCSX2_TARGET_ARCHITECTURES} MATCHES "armv7")
	# arm has unsigned char by default
	set(ARCH_FLAG "-march=armv7+fp -mfpu=neon -fsigned-char")
elseif(${PCSX2_TARGET_ARCHITECTURES} MATCHES "aarch64")
	set(ARCH_FLAG "-fsigned-char")
else()
...
# arm targets such as mac M1
	add_compile_options(-pipe -fvisibility=hidden -pthread -fno-operator-names)
endif()
endif()
